...
def gendata(data_path, out_path, ignored_sample_path=None, benchmark='xset', part='eval'):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='NTU-RGB-D120 Data Converter.')
    parser.add_argument('--data_path', default='../data/nturgbd_raw/nturgb+d120_skeletons/')
